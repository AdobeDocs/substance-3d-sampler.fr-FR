...
* **Sélection de canal** :\
  Sélectionnez la couche affectée par le filtre. Remarque : vous ne pouvez pas utiliser le filtre Luminosité/Contraste pour modifier la couche Normal, car son comportement est différent de celui de la plupart des couches.
* **Luminosité** : -1 à 1\
  Modifier la luminosité de la couche sélectionnée
* **Contraste** : -1 à 1\
  Modifier le contraste de la couche sélectionnée
