...
* **Segmentation avancée** : basculer\
  ...
  * **Masquer** **De** :\
    Sélectionnez un canal qui servira de source pour la génération du masque. Par exemple, masque de la valeur métallique remplace la base color des zones métalliques du matériau
* **Remplacer dans** :\
...
Ce masque est distinct du masque créé sous **Paramètres de base**. Vous pouvez utiliser un masque personnalisé pour effectuer une peinture ou utiliser une image pour spécifier les zones à affecter par le filtre **Remplacement de couleur** dans son ensemble.
...
Le filtre **Remplacement de couleur** est un excellent moyen de modifier l&#39;aspect de vos matériaux. Utilisez-le, par exemple, pour transformer une rouille de fer en cuivre oxydé
