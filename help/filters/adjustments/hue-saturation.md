...
* **Luminosité** : -1 à 1\
  Modifiez la luminosité de vos couleurs.
* **Coloriser** : activer/désactiver\
  Lorsque cette option est désactivée, le filtre ajuste les couleurs déjà présentes. Lorsque cette option est activée, le filtre remplace les couleurs en fonction des curseurs Teinte, Saturation et Luminosité tout en conservant les détails.
