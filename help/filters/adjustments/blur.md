...
* **Intensité** : 0-1\
  Réglage de la quantité de flou appliquée à toutes les couches

**Personnalisé par canaux**

Réglez le niveau de flou de chaque couche séparément à l’aide de ces options. Tout d’abord, activez le flou spécifique à la couche. Un curseur apparaît pour contrôler la quantité de flou appliquée à cette couche.
...
* ***Canal*** ***-*** **Intensité du flou** : 0-1\
  Ajustez le flou pour la couche spécifiée.
