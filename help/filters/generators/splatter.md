...
Éclaboussures d’autres matériaux sur le matériau.
...
* **Rotation à partir de la Pente d&#39;arrière-plan** : 0-1\
  Modifiez l&#39;impact des normales du matériau sous-jacent sur la rotation des instances.
...
* **Normal à partir de** **Arrière-plan** : 0-1\
  Ajustez l&#39;impact de la normale du matériau sous chaque instance sur la normale de l&#39;instance.
...
* **Rugosité À Partir De L&#39;Arrière-Plan** : 0-1\
  Ajustez l’impact de la valeur de rugosité du matériau sous-jacent sur la valeur de rugosité de chaque instance
...
* **Inclinaison par rapport à la Pente principale** : 0-1\
  Ajoutez une pente à chaque instance pour correspondre à la pente du matériau sous-jacent
...
* **Se conformer à l&#39;arrière-plan** : 0-1\
  Contrôlez l’impact de la map height d’arrière-plan sur la map height des instances. Cela vous permet de réduire les instances autour des détails de l’arrière-plan
...
* **Aléatoire Métallique** : -1 à 1\
  Ajouter ou soustraire des valeurs aléatoires du métallique de chaque instance
* **Métallique de l&#39;arrière-plan** : 0-1\
  Ajustez l’impact des valeurs métalliques d’arrière-plan sur chaque instance
...
* **Utiliser un masque personnalisé** : activer/désactiver\
  ...
  * **Masque personnalisé** : image/pinceau\
    Importez une image à utiliser comme masque ou peinture personnalisé directement dans la **Vue 2D**
  ...
  * **Opacité de masque personnalisée** : 0-1\
    Ajuster la force du masque personnalisé
...
1. Modifiez éventuellement le nombre d&#39;emplacements d&#39;entrée disponibles avec **Paramètres de base > Entrée de Matériau**
1. Faites glisser les matériaux dans les emplacements d’entrée Éclaboussures
