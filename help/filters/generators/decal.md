---
helpx_url: "https://helpx.adobe.com/fr/substance-3d-sampler/filters/generators/decal.html"
breadcrumb-title: ''
...
Le filtre Décalcomanie vous permet d’ajouter des instances d’un autre matériau à un emplacement spécifique. Ceci est utile pour ajouter des éléments tels que des autocollants ou des détails spécifiques qui pourraient ne pas être faciles à générer d’un point de vue procédural.
...
Avec le **filtre Décalcomanie**, des fissures et des dommages réalistes sont ajoutés au matériau.
...
* **Mode Répétition** :\
  Détermine s&#39;il faut placer une mosaïque au-delà des poignées dans la **Vue 2D**.\
  H représente Horizontal, tandis que V représente Vertical.
* **Correspondance des couleurs du Matériau inférieur** : 0-1\
  Ajustez les couleurs du matériau de la décalcomanie pour qu’elles correspondent à la valeur chromatique des calques situés en dessous.
...
* **Fusion d&#39;opacité normale** : 0-1\
  Modification de l’opacité des normales du matériau de décalcomanie
...
* **Échelle D&#39;Height De Décalcomanie** : 0-1\
  Modifier le contraste de la map height pour le matériau de la décalcomanie

**Paramètres avancés**

* **Transformation de décalcomanie** :\
  Ajustez les valeurs de transforme de la matrice pour la décalcomanie. En général, il est plus facile d&#39;utiliser simplement les poignées de la **Vue 2D** pour ajuster la transforme de la décalcomanie.
...
1. Faites glisser le matériau de décalcomanie dans l’emplacement d’entrée du calque de décalcomanie

Vous pouvez ajuster les paramètres du filtre dans le **panneau Propriétés** en sélectionnant le calque Décalcomanie.

Vous pouvez ajuster les paramètres du matériau d&#39;entrée de décalcomanie dans le **panneau Propriétés** en sélectionnant le matériau dans l&#39;emplacement d&#39;entrée.
