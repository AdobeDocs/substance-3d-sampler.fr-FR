...
breadcrumb-title: ''
description: Utilisez le générateur de mur de briques de Substance 3D Sampler pour créer des motifs de mur de brique et des textures de maçonnerie réalistes pour les matériaux.
...
DescriptionLe filtre de mur de briques génère un motif de brique en fonction des calques situés en dessous. Ceci est utile pour créer des murs de brique (comme son nom l&#39;indique), mais aussi des sols, ou partout où d&#39;autres briques sont utilisées.

Dans les images ci-dessous, un matériau d&#39;argile est converti en mur de brique avec le **filtre de brique**.
...
* **Obligation de Brique** :\
  Fusionner les briques en fonction du style sélectionné
* **Type de Brique** :\
  Sélectionner le style de brique
* **Mosaïque** : 1-25\
  Modifiez la quantité de répétition sur les axes X et Y.
* **Décalage** : 0-1\
...
* **Mode de mélange** :\
  Modifiez l’organisation des briques. L&#39;utilisation d&#39;un **mode de mélange** crée un deuxième ensemble de briques qui peuvent être contrôlées indépendamment de l&#39;ensemble de base.\
...
* **Trouble Cimentaire** : 0-1\
  Réglez la planéité du ciment. A des valeurs élevées, le ciment peut s&#39;élever au-dessus des briques.

**Âge**

* **Trouble De La Brique** : 0-1\
  Ajustez de manière aléatoire la rotation de chaque brique en 3 dimensions.
* **Éclat de Brique** : 0-1\
  Ajout de fissures dans les briques
* **Bord de Brique** : 0-1\
  Endommager et casser le bord des briques
* **Brique débloquée** : 0-1\
  Suppression aléatoire des briques
* **Variation de couleur de Brique** : 0-1\
  Modifier la couleur des briques pour rendre le mur moins uniforme
* **Sale De La Brique** : 0-1\
  Ajouter un dirt aux briques

**Paramètres avancés**

* **Intensité de la Fusion de l&#39;Height** : 0-1\
...
* **Intensité normale** : 0-1\
  Ajustez la force des normales générées par le filtre de mur de briques. Une valeur de 0 signifie qu’il n’y a pas de normales.
* **Intensité de l&#39;Ambient occlusion** : 0-1\
  Réglez la force de l’AO. Une valeur de 0 signifie en fait qu’il n’y a pas d’Ambient occlusion.

Guide d’utilisation

Le filtre de mur de briques divise le matériau sous-jacent en briques individuelles qu’il réorganise ensuite. Pour cette raison, le filtre Brickwall fonctionne mieux avec les surfaces dures comme les roches ou les métaux - en d&#39;autres termes, les matériaux les plus adaptés pour être des briques dans le monde réel.
