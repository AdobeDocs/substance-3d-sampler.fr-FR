...
* **Influence des contours** : 0-1\
  Ajustez la façon dont la rouille interagit avec les arêtes en fonction de la map curvature.
...
* **Intensité de la Rouille** : 0-1\
  Modifiez la force de l’effet rouille. Si vous augmentez cette valeur, la rouille semble plus ancienne et plus résistante.
...
* **Intensité de l&#39;Height de pelage** : 0-1\
  Ajustez l&#39;impact des pelures sur la map height.

**Gouttes**

* **Intensité des gouttes** : 0-1\
  Modifiez la force de l’effet de goutte à goutte.
