...
helpx_learn_topic: ""
helpx_tags: ""
title: Scripts et développement
...
* Utilisez Aide > Documentation de l’API Python... pour ouvrir la documentation.

* [Gestion des plug-ins et des scripts installés](manage-installed-plugins-and-scripts.md)
* [Création d’un plug-in avec Python et XML](create-a-plugin-with-python-and-qml.md)
* [Création d’un script avec Python](../scripting-and-development/create-script-with-python/create-a-script-with-python.md)
