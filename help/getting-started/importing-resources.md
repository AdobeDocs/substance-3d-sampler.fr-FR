...
>[!NOTE]
>
> Les ressources sont liées et non importées. Par conséquent, si un fichier de ressources est déplacé ou supprimé, les matériaux ou le contenu créés avec cette ressource seront affectés. Par conséquent, nous vous recommandons d’utiliser un dossier dédié pour les ressources Sampler.
> 
> Par défaut, les ressources incluses dans Sampler sont stockées sous C:\Program Files\Adobe\Adobe Substance 3D Sampler\Resources\assets

## Formats de fichiers pris en charge

| Type | Description |
| --- | --- |
| <b>Bitmaps/Images</b> (JPEG, PNG, etc.) | Vous pouvez faire glisser et déposer ou importer vos bitmaps dans le panneau <b>Calques </b>, ou dans SBSAR ou dans les paramètres de filtre qui permettent une entrée d’image. |
| <b>Packs de Substances</b> (SBSAR) | Vous pouvez importer des fichiers SBSAR dans le panneau <b>Actifs</b> ou dans le panneau <b>Calques</b>. |
