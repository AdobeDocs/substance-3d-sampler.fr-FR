...
>[!NOTE]
>
> Si vous recherchez la documentation de la version héritée **Substance Alchemist**, elle peut être téléchargée en tant que fichier [PDF](https://www.dropbox.com/s/sqvznduc12cuyuq/SubstanceAlchemist_June2021.pdf?dl=1) ici. Cette documentation se concentre désormais sur Substance 3D Sampler.
...
* [Activation et licences](getting-started/activation-and-licenses.md) : activez et gérez vos licences afin de pouvoir commencer à utiliser Sampler.
* [Configuration requise](getting-started/system-requirements.md)
* [Raccourcis](getting-started/shortcuts.md)
* [Importation de ressources](getting-started/importing-resources.md)
...
* [Préférences](interface/preferences/preferences.md)
...
* [Outils HDRI](filters/hdri-tools/hdri-tools.md)
...
* [Problèmes techniques](technical-support/technical-issues/technical-issues.md)
...
* [Version 5.0](release-notes/version-5-0-substance-3d-sampler.md)
* [Version 4.4](release-notes/version-4-4-substance-3d-sampler.md)
* [Version 4.3](release-notes/version-4-3-substance-3d-sampler.md)
