...
* [Créer une fenêtre](../getting-started/project-management.md)
* [Panneau d’action rapide](../interface/panels/quick-actions-panel.md)
...
<b>À partir de l’écran d’accueil</b>

Cliquer sur une action rapide

![](../assets/clickquickaction-ezgif.com-video-gif-converter.gif)

ou glisser-déposer une image sur une action rapide.

![](../assets/dndquickaction-ezgif.com-video-gif-converter.gif)

ou glisser-déposer une image sur une action rapide.

<b>À partir de Créer</b>

Choisissez une action rapide ou importez des fichiers et découvrez les actions rapides que vous pouvez utiliser avec votre saisie
...
* <b>Créer une ressource :</b> créez une nouvelle ressource à partir de l’action rapide sélectionnée.
* <b>Créer un projet :</b>Créez un projet à partir de l’action rapide sélectionnée.
