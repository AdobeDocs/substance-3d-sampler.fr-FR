...
* Utilisez la barre de recherche pour trouver rapidement des ressources.
* Filtrez les actifs par type.
* Regroupez les actifs par type ou par catégorie.
* Basculer entre la vue Liste et la vue Icône.

## Ajout de ressources au panneau Ressources

Pour ajouter vos propres ressources au panneau Ressources, cliquez sur **+** en bas à droite du **panneau Ressources**. Accédez à l’emplacement de votre ressource, sélectionnez-la et cliquez sur **Ouvrir**. Vous pouvez supprimer des actifs personnalisés du **panneau Actifs** en les faisant glisser sur la corbeille.
...
>[!NOTE]
>
> Seules les ressources personnalisées peuvent être supprimées dans le panneau **Ressources**. Il n’est pas possible de supprimer les actifs par défaut Sampler.
