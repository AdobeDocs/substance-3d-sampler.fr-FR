...
* **Appliquez** l&#39;action rapide à la pile de calques.
* **Configurez** l&#39;action rapide via les boîtes de dialogue.
* **Créez une ressource** à l’aide de l’action rapide sélectionnée.
* **Créez un projet** à l&#39;aide de l&#39;action rapide sélectionnée.

![Le panneau Actions rapides affichant les options pour une action donnée.](../../assets/6.0_QuickActions_SelectionOptions.png)
