...
breadcrumb-title: ''
description: Consultez les notes de mise à jour de Substance 3D Sampler version 3.0 pour en savoir plus sur le remaniement de l’interface utilisateur, les éclairages d'environnement, les filtres et l’intégration du Creative Cloud.
...
* [Transforme de déformation](../../filters/tools/warp-transform.md)
...
Sampler peut désormais [partager facilement des matériaux et des environnements d’éclairage](../../interface/panels/share-panel.md)avec Substance 3D Painter et Stager, en un seul clic.

### Nouveau Moteur de rendu en temps réel

* Prise en charge des matériaux ASM, permettant des recherches cohérentes entre les applications avec davantage de canaux de matériau.
...
* Possibilité de contrôler les textures par défaut sur un maillage
...
* [UI] Nouvelle barre d’outils pour accéder directement à des filtres spécifiques (Recadrage, Transforme, Transforme de Perspective, Tampon de Clone)
...
* [UI] Le widget Résolution est désormais directement accessible dans le viewport
...
* [Projet] Le nom de votre projet s’affiche au-dessus du viewport
...
* [Project] Ouverture d’un fichier de projet .ssa directement depuis l’explorateur du système d’exploitation
* [Projet] L’ouverture d’un fichier .sbsar à partir de votre explorateur de système d’exploitation lancera Sampler avec un nouveau projet .fichier sbsar prêt à l’emploi
* [Projet] Ouvrez un fichier .alch (ancien fichier de Substance Alchemist) à partir de votre explorateur de système d’exploitation
* [Panneau Projet] Nouveau panneau contenant tous les actifs créés dans un projet
* [Panneau Projet] Création d’une ressource (matériau ou éclairage d&#39;environnement) à l’aide de l’icône +
...
* [Éclairage d&#39;environnement] Créer un éclairage d&#39;environnement dans Substance 3D Sampler
* [Éclairage d&#39;environnement] Lors de la création d’un éclairage d&#39;environnement, le glisser-déposer d’images affiche la fenêtre Modèle de création d’Éclairage d&#39;environnement
* [Éclairage d&#39;environnement] Dans le modèle de création d’Éclairage d&#39;environnement, sélectionnez Importation d’environnement pour attribuer votre image à l’environnement dans la vue 3D
* [Éclairage d&#39;environnement] Dans le modèle de création d’Éclairage d&#39;environnement, sélectionnez Fusion HDR pour créer un éclairage d&#39;environnement à partir de plusieurs images à 360 degrés avec une exposition différente
* [Éclairage d&#39;environnement] Dans le modèle de création d’Éclairage d&#39;environnement, sélectionnez Utiliser comme bitmap pour modifier vos images avant de créer un éclairage d&#39;environnement
* [Éclairage d&#39;environnement] Affectez l’utilisation de l’environnement dans le calque d’importation d’image pour affecter directement l’image à l’environnement dans la vue 3D
* [Éclairage d&#39;environnement] Dans la Vue 2D de la couche d’environnement, une correction automatique des couleurs permet d’obtenir un rendu identique à celui de la vue 3D
* [Éclairage d&#39;environnement] Nouveau contenu dédié pour la création d’éclairages d&#39;environnement
* [Panneau Actifs] Les panneaux Ressources et Filtres sont fusionnés dans un nouveau panneau Actifs
* [Panneau Actifs] Le panneau Actifs prend désormais en charge les types d’actifs suivants : matériaux, filtres et images
...
* [Panneau Actifs] Filtrez le dossier actif par matériau, par filtre ou par image
* [Panneau Actifs] Combinez plusieurs filtres pour obtenir uniquement des matériaux et des images
...
* [Panneau Calques] Raccourci - Maj + B pour ajouter un matériau de base sur vos calques
* [Panneau Calques] Les calques disposent désormais d’un aperçu par vignettes (miniature du Matériau, icône de filtre ou aperçu d’image)
...
* [Export] Envoyer des matériaux et des éclairages d&#39;environnement vers Adobe Substance 3D Painter
* [Export] Envoyer des éclairages d&#39;environnement vers Adobe Substance 3D Stager
* [Rendu] Les nouvelles propriétés de matériau sont désormais prises en charge et rendues en 3D
* [Rendu] Ajout de la prise en charge de l’Éclat (Couleur de l&#39;éclat, opacité de l’Éclat et rugosité de l’Éclat)
* [Rendu] Ajout de la prise en charge du revêtement (Coat color, Coat roughness, Coat normal, Coat specular level et Coat IOR)
* [Rendu] Ajout de la prise en charge d’Anisotropie (Anisotropy level et Anisotropy angle)
...
* [Rendu] Introduction d’un nouveau moteur de rendu Realtime Moteur (2021) en version Beta
* [Rendu] Basculez entre les deux versions de rendu dans le panneau Paramètres du visualiseur
* [Rendu] Le moteur de rendu Realtime Moteur (2021) prend en charge les propriétés de matériau de translucency, d’absorption et de diffusion
* [Rendu] Le moteur de rendu Realtime Moteur (2021) introduit une nouvelle façon de calculer les ombres à partir de l’éclairage d&#39;environnement
* [Rendu] Le moteur de rendu Realtime Moteur (2021) calcule en temps réel l’irradiance de l’éclairage d&#39;environnement
* [Panneau Paramètres de Shader] Nouveau panneau Paramètres de Shader pour modifier des paramètres de shader de matériau spécifiques
* [Panneau Réglages Shader] Nouveaux paramètres (Échelle normale, Échelle height, Niveau height, Intensité des émissions, IOR, Intensité du Coat normal et IOR du revêtement)
* [Panneau Paramètres de Shader] Paramètres spécifiques pour le Moteur en temps réel 2021 (Subsurface scattering, Distance de diffusion, Décalage rouge et Diffusion Rayleigh)
* [Panneau Paramètres de Shader] Les valeurs des paramètres sont enregistrées par ressource
* [Panneau Paramètres de la visionneuse] Ajout d’un aperçu des éclairages d&#39;environnement par défaut
...
* [Panneau Paramètres de la visionneuse] Nouveau paramètre de flou d’environnement (spécifique au moteur de rendu Realtime Moteur 2021)
* [Localisation] Nouvelles traductions en allemand et français
* [Contenu] Nouveaux matériaux de démarrage par défaut
...
* [Contenu] Nouveau filtre transforme de déformation
* [Contenu] Nouvel Height du filtre AO
* [Contenu] Nouveau filtre Height à Normal
* [Contenu] Remplacement de couleur : remplacez-le dans les nouveaux canaux pris en charge (Éclat, Revêtement, Anisotropie,...).
* [Contenu] Variation de couleur - Mode manuel pour sélectionner exactement les couleurs à modifier
* [Contenu] Répétition - option pour visualiser les seams coupés
* [Contenu] Répétition : option permettant de peinture les seams coupés pour une répétition parfaite
* [Contenu] Correspondance : option permettant d’ajouter un matériau correspondant à sa couleur et à sa rugosité
...
* [Realtime Moteur 2021] Modification de la disposition, crash de l’application
* [Realtime Moteur 2021] calcul lourd, crash de l’application
* [Panneaux] MacOS : les panneaux non ancrés sont placés devant toutes les applications
* [Widgets] Les widgets Transforme et Positions peuvent disparaître. Masquez et affichez le calque pour les faire apparaître.
* [Export] L&#39;exportation SBSAR d&#39;un éclairage d&#39;environnement perd la précision de 32 nombres de bits par pixel
