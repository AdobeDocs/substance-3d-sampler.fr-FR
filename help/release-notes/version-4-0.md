---
helpx_url: "https://helpx.adobe.com/fr/substance-3d-sampler/release-notes/version-4-0.html"
breadcrumb-title: ''
...
Tout ce dont vous avez besoin pour commencer est une série de photos qui capturent les surfaces visibles d’un objet - un smartphone ou une caméra DLSR fonctionne parfaitement.
...
Une fois votre objet 3D reconstruit, optimisez le résultat avec la décimation automatique, l’UV et le baking.
...
Les viewports 2D et 3D peuvent être redimensionnés, intervertis et empilés verticalement.
...
* matériaux d&#39;exportation : `export_material`
* éclairages d&#39;environnement d&#39;exportation : `export_environment_light`
* maillage d&#39;exportation avec ou sans textures : `export_mesh` ou `export_3d_object`
...
* [capture 3D] Importez ou générez du noir et des masques blancs sur votre jeu de données
* [capture 3D] Résultat de l’alignement : affichez toutes les fonctions correspondantes sous forme de nuage de points
* [capture 3D] Résultat de l’alignement : affichage et interaction avec les caméras associées à chaque photo alignée
* [capture 3D] Définition de la zone de reconstruction avec un widget de cadre de sélection
* [capture 3D] Redimensionnez, translatez et faites pivoter tous les axes du widget du cadre de sélection
...
* [capture 3D] Chacune des versions est automatiquement décimée selon le numéro de face cible défini
* [capture 3D] L’étape de post-traitement déplie automatiquement les textures, les projette à nouveau, puis bake l’height normal et les informations d’IA à partir du maillage en mode HDR
* [capture 3D] Ajout du résultat original ou d’une version au projet Sampler
* [capture 3D] Nouveau calque de post-traitement de Maillage pour décimer, déplier, reprojeter automatiquement les textures et baker les détails du calque de maillage sous-jacent
* [capture 3D] Nouveau calque de Transforme de Maillage pour redimensionner, faire pivoter ou translater le calque de maillage sous-jacent
* [Exporter] Nouvelle fenêtre d’exportation
* [Export] Paramètres et interface utilisateur dédiés selon le type de ressource (matériau, éclairage d&#39;environnement, maillage)
...
* [Application] Les viewports 2D et 3D peuvent désormais être redimensionnés, permutés et empilés verticalement
...
* [Scripts] Ajout de fonctions d’exportation pour les matériaux, les éclairages d&#39;environnement et les objets 3D
* [Scripting] Ajout d’identifiants, de valeurs par défaut, de valeurs minimales et maximales, de libellés et de valeurs d’énumération aux paramètres
* [Scripts] Ajout de la fonction import\_textures pour définir une utilisation personnalisée lors de l’importation d’images

**Fixe**

* crash [Application] lors de l’ouverture d’un projet récent et de l’enregistrement dans la boîte de dialogue de confirmation
...
* [Application] crash potentiel lors de l&#39;ouverture de projets 3.2
...
* [Scripting] Crash lors de l’utilisation de &#39;open\_project()&#39; dans un script Python
...
* [UI] Icône de ressource manquante pour les éclairages d&#39;environnement dans le panneau Projet
...
* [capture 3D] Lors de l’utilisation de masques, la projection de texture peut être rompue
* [capture 3D] De petits artefacts peuvent apparaître sur votre objet si l’échelle dans la transforme du Maillage est trop petite
* [capture 3D] Le maillage exporté est peut-être vraiment petit. Réinitialiser l’échelle de la transforme du Maillage et réexporter
