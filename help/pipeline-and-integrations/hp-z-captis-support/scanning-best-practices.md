...
Tout ce qui est visible sur l&#39;échantillon lors de la capture est baké dans les cartes. Quelques minutes de préparation suppriment les problèmes à la source, avant qu&#39;ils ne deviennent du travail d&#39;édition.

**Nettoyer l&#39;échantillon**

Nettoyez rapidement l&#39;échantillon avant de le placer. Toute marque sur la surface sera interprétée comme un détail de matériau et reproduite sur chaque canal.

**Supprimer le dust et les particules étrangères**

Le dust, les cheveux, les fils et les autres particules détachées sont l&#39;une des sources les plus courantes de travail de post-traitement. Brossez ou utilisez de l’air comprimé pour nettoyer la surface, car chaque particule restante doit être peinte à la main ultérieurement.

![](../../assets/scanning/clean-textile.png)

**Tissus de fer pour supprimer les rides**

Pour les tissus et autres matériaux souples, repassez toujours l&#39;échantillon à plat avant de le scanner. Les plis et les plis créent de fausses informations d’height et d’ombre qui sont difficiles à supprimer ultérieurement et qui rompent la carrelage du matériau.

![](../../assets/scanning/flatten-textile.png)

**Supprimer les taches sur les surfaces lisses**

Sur les matériaux lisses et non poreux, essuyez les taches, les empreintes digitales ou les taches. Celles-ci apparaissent clairement dans les canaux de base color et de rugosité.
...
Un bon placement permet de maintenir le matériau plat, net et centré, ce qui réduit le recadrage, la déformation et l’alignement que vous devrez effectuer ultérieurement.

![](../../assets/scanning/center-textile.png)

**Centrer le matériau dans la zone de numérisation**
...
Une fois votre matériau importé, utilisez les filtres Sampler (Égaliser, Répétition automatique, Recadrage de la Perspective, Répétition, ...) pour la touche finale et exportez-le lorsque vous êtes satisfait du résultat.
